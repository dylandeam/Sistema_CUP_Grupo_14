                        ...
                        <tbody>
                            ...
                            @foreach($turnos as $turno)
                                <tr>
                                    ...
                                    <td style="text-align: center">{{ $turno->nombre }}</td>
                                    <td style="text-align: center">
                                        <div class="btn-group" role="group">
                                            
                                            {{-- Botón Editar --}}
                                            <a href="{{ url('/admin/turnos/'.$turno->id.'/edit') }}" class="btn btn-success btn-sm"><i class="fas fa-edit"></i></a>
                                            
                                            {{-- Botón Eliminar --}}
                                            <form action="{{ url('/admin/turnos/'.$turno->id) }}" method="POST" id="miformulario{{ $turno->id }}" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" onclick="confirmarEliminacion(event, {{ $turno->id }})" class="btn btn-danger btn-sm">
