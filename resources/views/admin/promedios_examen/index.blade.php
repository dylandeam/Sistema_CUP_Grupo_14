...
@section('content_header')
    <h1><b>Promedios de Exámenes</b></h1>
    <hr>
@stop
    ...
    @else
        ...
        <div class="col-md-12">
            <div class="alert alert-info">
                ...
                <strong>Gestión Activa:</strong> {{ $gestionActiva->semestre }} - {{ $gestionActiva->año }}
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                <div class="card-header bg-primary">
                    <h3 class="card-title"><i class="fas fa-chart-bar mr-2"></i>Grupos Disponibles</h3>
                </div>
                <div class="card-body">
                    @if($grupos->isEmpty())
                        <div class="alert alert-info">
                                ...
                                <tbody>
                                    @foreach($grupos as $grupo)
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <a href="{{ route('admin.promedios_examen.show', $grupo->id) }}" 
                                                   class="btn btn-sm btn-info" 
                                                   title="Ver promedios de exámenes de este grupo">
                                                    <i class="fas fa-chart-line mr-1"></i>Ver Promedios
                                                </a>
                                            </td>
                                        </tr>
                                    @endforeach
