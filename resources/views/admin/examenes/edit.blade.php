...
@section('content_header')
    <h1><b>Exámenes / Editar examen</b></h1>
    <hr>
@stop
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('admin/examenes/'.$examen->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="nro_examen"
                                       value="{{ old('nro_examen', $examen->nro_examen) }}" required>
                            </div>
                            @error('nro_examen')
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="date" class="form-control" name="fecha"
                                       value="{{ old('fecha', $examen->fecha) }}" required>
                            </div>
                            @error('fecha')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" step="0.01" min="0" max="1" class="form-control" name="ponderacion"
                                       value="{{ old('ponderacion', $examen->ponderacion) }}" required>
                            </div>
                            @error('ponderacion')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            @else
                                <div class="alert alert-danger">
                                    ...
                                    No hay gestiones activas. No se puede actualizar el examen hasta que exista una gestión activa.
                                </div>
                            @endif
                        </div>
