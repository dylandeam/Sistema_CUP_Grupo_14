            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ url('admin/materias/create') }}" class="btn btn-primary">Nueva Materia</a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            @foreach($materias as $materia)
                                <tr>
                                    ...
                                    <td style="text-align: center">{{ $materia->ponderacion }}</td>
                                    <td style="text-align: center">
                                        <div class="btn-group" role="group">
                                            ...
                                            {{-- Botón Eliminar --}}
                                            <form action="{{ url('/admin/materias/'.$materia->id) }}" method="POST" id="miformulario{{ $materia->id }}" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" onclick="confirmarEliminacion(event, {{ $materia->id }})" class="btn btn-danger btn-sm">
