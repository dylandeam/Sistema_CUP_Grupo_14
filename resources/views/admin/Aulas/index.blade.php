            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ url('admin/aulas/create') }}" class="btn btn-primary">Registrar Nueva Aula</a>
                    </div>
                </div>
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-hover table-striped table-sm">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center">Nro Aula</th>   
                        ...
                        <tbody>
                            ...
                            @foreach($aulas as $aula)
                                <tr>
                                    ...
                                    <td style="text-align: center">{{ $aula->nro_aula }}</td>
                                    <td style="text-align: center">{{ $aula->modulo }}</td>
                                    <td style="text-align: center">{{ $aula->piso }}</td>
                                    <td style="text-align: center">
                                        <div class="btn-group" role="group">
                                            ...
                                            {{-- Botón Eliminar --}}
                                            <form action="{{ url('/admin/aulas/'.$aula->id) }}" method="POST" id="miformulario{{ $aula->id }}" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" onclick="confirmarEliminacion(event, {{ $aula->id }})" class="btn btn-danger btn-sm">
...
@section('js')
    ...
    <script>
        function confirmarEliminacion(event, id) {
            ...
            Swal.fire({
                title: '¿Desea eliminar este aula?',
                icon: 'question',
                showDenyButton: true,
        ...
        $(function () {
            $("#example1").DataTable({
                ...
                language: {
                    ...
                    infoEmpty: "Mostrando 0 a 0 de 0 Aulas",
                    infoFiltered: "(Filtrado de _MAX_ total Aulas)",
